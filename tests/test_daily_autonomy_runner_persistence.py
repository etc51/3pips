...
class DailyAutonomyRunnerPersistenceTest(unittest.TestCase):
    ...
    def test_main_persists_status_and_latest_artifacts_with_strategy_review(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(latest_status["stages"]["microstructure_gate_research"]["source_review_rows_day"], 0)
            self.assertEqual(latest_status["stages"]["microstructure_gate_research"]["source_review_rows_all"], 0)
            self.assertEqual(latest_status["stages"]["microstructure_gate_research"]["rows"], 0)
            self.assertIn("Collect wide-spread review snapshots", latest_status["stages"]["microstructure_gate_research"]["next_action"])
            ...
            self.assertEqual(latest_status["stages"]["microstructure_counterfactual"]["source_entry_shadow_rows_day"], 0)
            self.assertEqual(latest_status["stages"]["microstructure_counterfactual"]["source_entry_shadow_rows_all"], 0)
            self.assertEqual(latest_status["stages"]["microstructure_counterfactual"]["unique_entries_day"], 0)
            self.assertEqual(latest_status["stages"]["microstructure_counterfactual"]["unique_entries"], 0)
            self.assertIn("Collect first entry-shadow rows", latest_status["stages"]["microstructure_counterfactual"]["next_action"])
            ...
            self.assertEqual(latest_micro_gate_summary["source_review_rows_day"], 0)
            ...
            self.assertEqual(latest_micro_counter_summary["source_entry_shadow_rows_all"], 0)
